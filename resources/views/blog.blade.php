...
<html lang="en">
  ...
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('backend/img/logo.png') }}" type="image/x-icon">

    <title>Selamat Datang di IKA &mdash; Universitas Widya Dharma Pontianak</title>
  ...
  <body>
    ...
    <header id="header">
      ...
      <div id="nav">
        ...
        <div id="nav-bottom">
          <div class="container">
            <ul class="nav-menu nav-logo">
                <li>
                    <a href="{{ url('/') }}" class="logo"><img src="{{ asset('backend/img/logo.png') }}"
                        alt="logo" width="50"></a>
                </li>
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="post">
                  <a class="post-img" href="#"><img src="{{ $post_terbaru->image }}" alt=""></a>
                  <div class="post-body">
                    <div class="post-category">
                      <a href="#">{{ $post_terbaru->category->name }}</a>
                    </div>
                    <h3 class="post-title">
                        <a href="#">{{ $post_terbaru->title }}</a>
                    </h3>
                    <ul class="post-meta">
